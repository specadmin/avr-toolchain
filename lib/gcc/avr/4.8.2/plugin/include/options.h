...
#endif
#ifdef GENERATOR_FILE
extern int flag_split_darrays;
#else
  int x_flag_split_darrays;
#define flag_split_darrays global_options.x_flag_split_darrays
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_Wcast_result = 185,                    /* -Wcast-result */
  ...
  OPT_cpp_ = 423,                            /* -cpp= */
  OPT_d = 424,                               /* -d */
  OPT_debuglib_ = 425,                       /* -debuglib= */
  OPT_defaultlib_ = 426,                     /* -defaultlib= */
  ...
  OPT_fdeps_ = 543,                          /* -fdeps= */
  OPT_fdevirtualize = 544,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_caret = 545,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 546,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 547,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 548,                /* -fdirectives-only */
  OPT_fdisable_ = 549,                       /* -fdisable- */
  OPT_fdisable_assertions = 550,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 551,            /* -fdisable-assertions= */
  OPT_fdoc = 552,                            /* -fdoc */
  OPT_fdoc_dir_ = 553,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 554,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 555,                       /* -fdoc-inc= */
  ...
  OPT_femit_moduleinfo = 582,                /* -femit-moduleinfo */
  ...
  OPT_femit_templates = 586,                 /* -femit-templates */
  OPT_fenable_ = 587,                        /* -fenable- */
  OPT_fenable_assertions = 588,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 589,             /* -fenable-assertions= */
  OPT_fencoding_ = 590,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 591,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 592, */           /* -fenum-int-equiv */
  OPT_fexceptions = 593,                     /* -fexceptions */
  OPT_fexcess_precision_ = 594,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 595,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 596,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 597,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 598,                       /* -fextdirs= */
  OPT_fextended_identifiers = 599,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 600,                /* -fextern-tls-init */
  OPT_fexternal_blas = 601,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 602, */       /* -fexternal-templates */
  OPT_ff2c = 603,                            /* -ff2c */
  OPT_ffast_math = 604,                      /* -ffast-math */
  OPT_ffat_lto_objects = 605,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 606,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 607,               /* -ffinite-math-only */
  OPT_ffixed_ = 608,                         /* -ffixed- */
  OPT_ffixed_form = 609,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 610,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 611,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 612,                    /* -ffloat-store */
  OPT_ffor_scope = 613,                      /* -ffor-scope */
  /* OPT_fforce_addr = 614, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 615,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 616,              /* -fforward-propagate */
  OPT_ffp_contract_ = 617,                   /* -ffp-contract= */
  ...
  OPT_fignore_unknown_pragmas = 658,         /* -fignore-unknown-pragmas */
  ...
  OPT_fin = 663,                             /* -fin */
  OPT_findirect_classes = 664,               /* -findirect-classes */
  OPT_findirect_dispatch = 665,              /* -findirect-dispatch */
  OPT_findirect_inlining = 666,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 667,         /* -finhibit-size-directive */
  OPT_finit_character_ = 668,                /* -finit-character= */
  OPT_finit_integer_ = 669,                  /* -finit-integer= */
  OPT_finit_local_zero = 670,                /* -finit-local-zero */
  OPT_finit_logical_ = 671,                  /* -finit-logical= */
  OPT_finit_real_ = 672,                     /* -finit-real= */
  OPT_finline = 673,                         /* -finline */
  OPT_finline_atomics = 674,                 /* -finline-atomics */
  OPT_finline_functions = 675,               /* -finline-functions */
  OPT_finline_functions_called_once = 676,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 677, */            /* -finline-limit- */
  OPT_finline_limit_ = 678,                  /* -finline-limit= */
  OPT_finline_small_functions = 679,         /* -finline-small-functions */
  OPT_finput_charset_ = 680,                 /* -finput-charset= */
  OPT_finstrument_functions = 681,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 682,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 683,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 684,            /* -finteger-4-integer-8 */
  OPT_fintfc = 685,                          /* -fintfc */
  OPT_fintfc_dir_ = 686,                     /* -fintfc-dir= */
  OPT_fintfc_file_ = 687,                    /* -fintfc-file= */
  OPT_fintrinsic_modules_path = 688,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 689,        /* -fintrinsic-modules-path= */
  OPT_finvariants = 690,                     /* -finvariants */
  OPT_fipa_cp = 691,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 692,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 693, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 694,                    /* -fipa-profile */
  OPT_fipa_pta = 695,                        /* -fipa-pta */
  OPT_fipa_pure_const = 696,                 /* -fipa-pure-const */
  OPT_fipa_reference = 697,                  /* -fipa-reference */
  OPT_fipa_sra = 698,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 699, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 700,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 701,             /* -fira-hoist-pressure */
  ...
  OPT_floop_block = 716,                     /* -floop-block */
  /* OPT_floop_flatten = 717, */             /* -floop-flatten */
  OPT_floop_interchange = 718,               /* -floop-interchange */
  OPT_floop_nest_optimize = 719,             /* -floop-nest-optimize */
  ...
  OPT_flto_partition_max = 727,              /* -flto-partition=max */
  OPT_flto_partition_none = 728,             /* -flto-partition=none */
  OPT_flto_report = 729,                     /* -flto-report */
  OPT_flto_ = 730,                           /* -flto= */
  OPT_fltrans = 731,                         /* -fltrans */
  OPT_fltrans_output_list_ = 732,            /* -fltrans-output-list= */
  OPT_fmain_ = 733,                          /* -fmain= */
  OPT_fmake_deps_ = 734,                     /* -fmake-deps= */
  OPT_fmake_mdeps_ = 735,                    /* -fmake-mdeps= */
  OPT_fmath_errno = 736,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 737,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 738,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 739,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 740,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 741,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 742,                     /* -fmem-report */
  OPT_fmem_report_wpa = 743,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 744,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 745,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 746,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 747,                /* -fmessage-length= */
  OPT_fmodule_private = 748,                 /* -fmodule-private */
  OPT_fmodulo_sched = 749,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 750,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 751,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 752,                  /* -fms-extensions */
  OPT_fmudflap = 753,                        /* -fmudflap */
  OPT_fmudflapir = 754,                      /* -fmudflapir */
  OPT_fmudflapth = 755,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 756, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 757, */                  /* -fnew-abi */
  OPT_fnext_runtime = 758,                   /* -fnext-runtime */
  OPT_fnil_receivers = 759,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 760,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 761,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 762, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 763,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 764,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 765,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 766,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 767,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 768,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 769,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 770,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 771,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 772,             /* -fomit-frame-pointer */
  OPT_fonly_ = 773,                          /* -fonly= */
  OPT_fopenmp = 774,                         /* -fopenmp */
  OPT_foperator_names = 775,                 /* -foperator-names */
  OPT_fopt_info = 776,                       /* -fopt-info */
  OPT_fopt_info_ = 777,                      /* -fopt-info- */
  OPT_foptimize_register_move = 778,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 779,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 780,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 781,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 782, */           /* -foptional-diags */
  OPT_fout = 783,                            /* -fout */
  OPT_foutput_class_dir_ = 784,              /* -foutput-class-dir= */
  OPT_fpack_derived = 785,                   /* -fpack-derived */
  OPT_fpack_struct = 786,                    /* -fpack-struct */
  OPT_fpack_struct_ = 787,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 788,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 789,              /* -fpcc-struct-return */
  OPT_fpch_deps = 790,                       /* -fpch-deps */
  OPT_fpch_preprocess = 791,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 792,                     /* -fpeel-loops */
  OPT_fpeephole = 793,                       /* -fpeephole */
  OPT_fpeephole2 = 794,                      /* -fpeephole2 */
  OPT_fpermissive = 795,                     /* -fpermissive */
  OPT_fpic = 796,                            /* -fpic */
  OPT_fpie = 797,                            /* -fpie */
  OPT_fplan9_extensions = 798,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 799,                    /* -fplugin-arg- */
  OPT_fplugin_ = 800,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 801,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 802,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 803,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 804,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 805,                   /* -fpreprocessed */
  OPT_fpretty_templates = 806,               /* -fpretty-templates */
  OPT_fprofile = 807,                        /* -fprofile */
  OPT_fprofile_arcs = 808,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 809,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 810,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 811,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 812,              /* -fprofile-generate= */
  OPT_fprofile_report = 813,                 /* -fprofile-report */
  OPT_fprofile_use = 814,                    /* -fprofile-use */
  OPT_fprofile_use_ = 815,                   /* -fprofile-use= */
  OPT_fprofile_values = 816,                 /* -fprofile-values */
  OPT_fproperty = 817,                       /* -fproperty */
  OPT_fprotect_parens = 818,                 /* -fprotect-parens */
  OPT_frandom_seed = 819,                    /* -frandom-seed */
  OPT_frandom_seed_ = 820,                   /* -frandom-seed= */
  OPT_frange_check = 821,                    /* -frange-check */
  OPT_freal_4_real_10 = 822,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 823,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 824,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 825,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 826,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 827,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 828,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 829,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 830,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 831,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 832,                /* -frecord-marker=8 */
  OPT_frecursive = 833,                      /* -frecursive */
  OPT_freduced_reflection = 834,             /* -freduced-reflection */
  OPT_free = 835,                            /* -free */
  OPT_freg_struct_return = 836,              /* -freg-struct-return */
  OPT_fregmove = 837,                        /* -fregmove */
  OPT_frelease = 838,                        /* -frelease */
  ...
  OPT_frounding_math = 851,                  /* -frounding-math */
  OPT_frtti = 852,                           /* -frtti */
  OPT_fsanitize_address = 853,               /* -fsanitize=address */
  OPT_fsanitize_thread = 854,                /* -fsanitize=thread */
  ...
  OPT_fsingle_precision_constant = 894,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 895,               /* -fsource-filename= */
  OPT_fsource_ = 896,                        /* -fsource= */
  OPT_fsplit_dynamic_arrays = 897,           /* -fsplit-dynamic-arrays */
  ...
  OPT_fstack_reuse_ = 910,                   /* -fstack-reuse= */
  OPT_fstack_usage = 911,                    /* -fstack-usage */
  OPT_fstats = 912,                          /* -fstats */
  OPT_fstore_check = 913,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 914, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 915,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 916,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 917,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 918, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 919,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 920,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 921,                    /* -fsyntax-only */
  OPT_ftabstop_ = 922,                       /* -ftabstop= */
  /* OPT_ftarget_help = 923, */              /* -ftarget-help */
  OPT_ftarget_ = 924,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 925,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 926, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 927,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 928,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 929, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 930,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 931,             /* -fthreadsafe-statics */
  OPT_ftime_report = 932,                    /* -ftime-report */
  OPT_ftls_model_ = 933,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 934,               /* -ftoplevel-reorder */
  OPT_ftracer = 935,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 936,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 937,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 938,                  /* -ftrapping-math */
  OPT_ftrapv = 939,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 940,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 941,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 942,                       /* -ftree-ccp */
  OPT_ftree_ch = 943,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 944,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 945,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 946,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 947,                /* -ftree-copyrename */
  OPT_ftree_cselim = 948,                    /* -ftree-cselim */
  OPT_ftree_dce = 949,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 950,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 951,                       /* -ftree-dse */
  OPT_ftree_forwprop = 952,                  /* -ftree-forwprop */
  OPT_ftree_fre = 953,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 954,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 955,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 956,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 957,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 958,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 959,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 960, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 961,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 962,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 963,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 964,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 965,                   /* -ftree-phiprop */
  OPT_ftree_pre = 966,                       /* -ftree-pre */
  OPT_ftree_pta = 967,                       /* -ftree-pta */
  OPT_ftree_reassoc = 968,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 969, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 970,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 971,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 972,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 973,                      /* -ftree-slsr */
  OPT_ftree_sra = 974,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 975, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 976, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 977,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 978,                /* -ftree-tail-merge */
  OPT_ftree_ter = 979,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 980,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 981,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 982,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 983,                       /* -ftree-vrp */
  OPT_funderscoring = 984,                   /* -funderscoring */
  OPT_funit_at_a_time = 985,                 /* -funit-at-a-time */
  OPT_funittest = 986,                       /* -funittest */
  OPT_funroll_all_loops = 987,               /* -funroll-all-loops */
  OPT_funroll_loops = 988,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 989,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 990,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 991,             /* -funsigned-bitfields */
  OPT_funsigned_char = 992,                  /* -funsigned-char */
  OPT_funswitch_loops = 993,                 /* -funswitch-loops */
  OPT_funwind_tables = 994,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 995,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 996,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 997,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 998,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 999,          /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1000,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1001,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1002,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1003,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1004,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1005,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1006,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1007,/* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 1008,               /* -fvect-cost-model */
  OPT_fverbose_asm = 1009,                   /* -fverbose-asm */
  /* OPT_fversion = 1010, */                 /* -fversion */
  OPT_fversion_ = 1011,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1012,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1013,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1014,                   /* -fvisibility= */
  OPT_fvpt = 1015,                           /* -fvpt */
  /* OPT_fvtable_gc = 1016, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1017, */           /* -fvtable-thunks */
  ...
  OPT_mlog_ = 1073,                          /* -mlog= */
  OPT_mmcu_ = 1074,                          /* -mmcu= */
  OPT_mno_interrupts = 1075,                 /* -mno-interrupts */
  OPT_morder1 = 1076,                        /* -morder1 */
  OPT_morder2 = 1077,                        /* -morder2 */
  OPT_mpmem_wrap_around = 1078,              /* -mpmem-wrap-around */
  OPT_mrelax = 1079,                         /* -mrelax */
  OPT_msp8 = 1080,                           /* -msp8 */
  OPT_mstrict_X = 1081,                      /* -mstrict-X */
  OPT_mtiny_stack = 1082,                    /* -mtiny-stack */
  OPT_n = 1083,                              /* -n */
  ...
  OPT_nophoboslib = 1088,                    /* -nophoboslib */
  ...
  OPT_static_libphobos = 1129,               /* -static-libphobos */
